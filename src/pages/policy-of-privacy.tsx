...
export default function PolicyOfPrivacy() {
  return (
    <div className="w-[50vw] ml-auto mr-auto">
      ...
      <p>
        A sua privacidade é importante para nós. É política do Book Shelf
        respeitar a sua privacidade em relação a qualquer informação sua que
        possamos coletar no site{" "}
        <Link href="https://dms-bookshelf.vercel.app">Book Shelf</Link>, e
      ...
      <p>
        ...
        informação que o Book Shelf oferece no site e com caráter enunciativo,
        mas não limitativo:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          (softwares) do Book Shelf, de seus fornecedores ou terceiros, para
      ...
      <p>
        Esta política é efetiva a partir de <strong>Apr</strong>/
        <strong>2023</strong>.
      </p>
    </div>
  );
